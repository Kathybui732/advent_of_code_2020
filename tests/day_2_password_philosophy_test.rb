...
require './lib/day_2_password_philosophy'

class PasswordPhilosophyTest < MiniTest::Test

  def setup
    @password_philosophy = PasswordPhilosophy.new
    @password_list_1 = [[1..3, 'a', 'abcde'],
      [1..3, 'b', 'cdefg'],
      [2..9, 'c', 'ccccccccc']
    ]
    @password_list_2 = [[(3..4), 'l', 'vdcv'],
      [(6..9), 'd', 'dddddkzdl'],
  ...
  def test_valid_password_count
    assert_equal 2, @password_philosophy.valid_password_count(@password_list_1)
    assert_equal 447, @password_philosophy.valid_password_count(@password_list_2)
  end

  def test_new_valid_password_count
    assert_equal 1, @password_philosophy.new_valid_password_count(@password_list_1)
    assert_equal 249, @password_philosophy.new_valid_password_count(@password_list_2)
  end
end
