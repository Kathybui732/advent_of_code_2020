...
class PasswordPhilosophyTest < MiniTest::Test
  ...
  def test_valid_password_count
    assert_equal 2, @password_philosophy.valid_password_count(@password_list)
  end

  def test_valid_password_count_problems
    ...
    assert_equal 447, @password_philosophy.valid_password_count(passwords)
    assert_equal 447, @password_philosophy.find_all_valid(passwords)
  end
end
